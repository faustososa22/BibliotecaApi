...
namespace BibliotecaAPI.Utilidades
{
    public class AutoMapperProfiles: Profile
    {
        public AutoMapperProfiles()
        {
            ...
            CreateMap<AutoresLibros, LibroDTO>()
            ...
            CreateMap<LibroCreacionDTO, Libro>()
                .ForMember(ent => ent.Autores, config => config.MapFrom(dto => dto.AutoresId.Select(id => new AutoresLibros { AutorId = id})));

            CreateMap<Libro, LibroConAutoresDTO>();

            CreateMap<AutoresLibros, AutorDTO>()
            ...
            CreateMap<LibroCreacionDTO, AutoresLibros>()
